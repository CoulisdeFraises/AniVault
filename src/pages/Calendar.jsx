...
export function Calendar() {
  ...
  const renderDay = ({ date, entries }, globalIdx) => {
  ...
  return (
    <div className="relative h-[100dvh] flex flex-col overflow-hidden bg-violet-950 text-violet-50" style={{ fontFamily: "'Inter', sans-serif" }}>
      ...
      <div className="relative z-10 flex-shrink-0 max-w-5xl w-full mx-auto px-3 sm:px-6 pt-safe-8">
        ...
        <div className="flex justify-center mb-3">
          <div className="inline-flex w-full max-w-md items-center gap-1 rounded-full bg-white/5 border border-white/10 p-1">
            <FilterTab layoutId="calendar-content-filter-pill" active={contentFilter === "all"}       onClick={() => setContentFilter("all")}>Tout</FilterTab>
            <FilterTab layoutId="calendar-content-filter-pill" active={contentFilter === "mylibrary"} onClick={() => setContentFilter("mylibrary")}>Ma liste</FilterTab>
            <FilterTab layoutId="calendar-content-filter-pill" active={contentFilter === "new"}       onClick={() => setContentFilter("new")}>Nouvelles</FilterTab>
            <FilterTab layoutId="calendar-content-filter-pill" active={contentFilter === "returning"} onClick={() => setContentFilter("returning")}>Reprises</FilterTab>
          </div>
        </div>
        ...
        {!loading && (
          <div className="flex items-stretch gap-1.5 mb-3">
            ...
            <WeekStrip
              ...
              onSelect={jumpToDay}
              layoutId="calendar-week-strip-pill"
            />
            <button
      ...
      <PullToRefresh onRefresh={() => load(weekOffset, true)} className="relative z-10 flex-1 min-h-0 flex flex-col">

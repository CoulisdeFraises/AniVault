        ...
        {TABS.map(({ path, label, icon: Icon }) => {
          ...
          return (
            <button
              ...
              className={`flex-1 min-w-0 flex items-center justify-center gap-1.5 px-3 py-2 rounded-full text-xs font-medium transition-all active:scale-95 motion-reduce:transition-none whitespace-nowrap ${
